...
#$wikiDir = $readmeDir + "\wiki"
#& $git clone https://neelabo@bitbucket.org/neelabo/realtimesearch.git/wiki $wikiDir
#"$wikiDir\ChangeLog.md"
...
Remove-Item $readmeDir -Recurse -Force
