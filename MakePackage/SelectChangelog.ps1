...
Write-Output ""
if ($Culture -eq "ja-jp") {
    Write-Output "これ以前の更新履歴は [こちら](https://neelabo.github.io/RealtimeSearch/ja-jp/ChangeLog.html) を参照してください。"
}
else {
    Write-Output "Please see [here](https://neelabo.github.io/RealtimeSearch/en-us/ChangeLog.html) for the previous change log."
}
